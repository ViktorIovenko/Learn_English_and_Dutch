...
HELP_TEXT = (
    ...
    "Поддерживаемые заголовки (можно на русском/англ, в любом порядке):\n"
    "  № / No / Number / Номер            → number\n"
    "  Урок / Lesson                      → lesson\n"
    "  Нидерландское слово / Dutch / NL   → nl\n"
    "  English / Английский               → en\n"
    "  Русский / Russian                  → ru\n"
    "  Пример (NL)                        → ex_nl\n"
    "  Пример (EN)                        → ex_en\n"
    "  Пример (RU)                        → ex_ru\n"
    "  Audio NL / Audio EN / Audio RU     → audio_nl / audio_en / audio_ru\n\n"
    "Минимум обязательных полей: number, nl, en, ru.\n"
    "Если 'lesson' пустой, он берётся из предыдущей строки или из 'number' (формат '1.1 Familie (1)').\n\n"
    "❗ Проверка: слово должно встречаться в своём примере.\n"
    "   Если перевод содержит несколько вариантов (/, ,, ;, варианты в скобках) — достаточно любого одного.\n"
)
